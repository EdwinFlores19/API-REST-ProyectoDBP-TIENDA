...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=EDWINFLORES;Initial Catalog=INFOCHILL;Integrated Security=True;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdAdmin).HasName("PK__TB_ADMIN__B2C3ADE5DB44FDE1");
        ...
        {
            entity.HasKey(e => e.IdDet).HasName("PK__TB_DETAL__3E41457FB78CB119");
            ...
            entity.HasOne(d => d.IdFacNavigation).WithMany(p => p.TbDetalleFacturas)
                ...
                .HasConstraintName("FK__TB_DETALL__idFac__32E0915F");

            entity.HasOne(d => d.IdProNavigation).WithMany(p => p.TbDetalleFacturas)
                .HasForeignKey(d => d.IdPro)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TB_DETALL__idPro__33D4B598");
        });

        modelBuilder.Entity<TbFactura>(entity =>
        {
            entity.HasKey(e => e.IdFac).HasName("PK__TB_FACTU__39C0459A09BF3069");
            ...
            entity.HasOne(d => d.CodUsuNavigation).WithMany(p => p.TbFacturas)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TB_FACTUR__codUs__300424B4");
        });

        modelBuilder.Entity<TbProducto>(entity =>
        {
            entity.HasKey(e => e.IdPro).HasName("PK__TB_PRODU__3D795B271245BD98");
        ...
        {
            entity.HasKey(e => e.CodProveedor).HasName("PK__TB_PROVE__26E566FB2E3C06BA");
        ...
        {
            entity.HasKey(e => e.CodUsu).HasName("PK__TB_USUAR__9B80588171FA4A22");
